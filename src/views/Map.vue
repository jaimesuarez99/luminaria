...
const handleLmClicked = (event) => {
  console.log("handleLmClicked", event);
  selectedLmUid.value = event; // Asignar las coordenadas seleccionadas
};
